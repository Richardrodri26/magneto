  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-magneto-primary text-magneto-primary-foreground hover:bg-magneto-primary hover:text-magneto-primary-foreground focus:bg-magneto-primary focus:text-magneto-primary-foreground",
